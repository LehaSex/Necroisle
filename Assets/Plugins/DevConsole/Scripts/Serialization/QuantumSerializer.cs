...
namespace Necroisle.DevConsole
{
    ...
    {
        private readonly IDevConsoleSerializer[] _serializers;
        private readonly Dictionary<Type, IDevConsoleSerializer> _serializerLookup = new Dictionary<Type, IDevConsoleSerializer>();
        ...
        /// </summary>
        /// <param name="serializers">The IDevConsoleSerializers to use in this Quantum Serializer.</param>
        public QuantumSerializer(IEnumerable<IDevConsoleSerializer> serializers)
        {
        ...
        /// </summary>
        public QuantumSerializer() : this(new InjectionLoader<IDevConsoleSerializer>().GetInjectedInstances())
        {
        ...
        public string SerializeFormatted(object value, QuantumTheme theme = null)
        {
            ...
            string SerializeInternal(IDevConsoleSerializer serializer)
            {
                try
                {
            ...
            else
            {
                ...
                foreach (IDevConsoleSerializer serializer in _serializers)
                {
