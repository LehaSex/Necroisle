using Necroisle.DevConsole.Editor.Tools;
using Necroisle.DevConsole.QGUI;
using UnityEditor;
using UnityEngine;

namespace Necroisle.DevConsole.Editor
{
    [CustomEditor(typeof(QuantumConsole), true)]
    public class QuantumConsoleInspector : DevConsoleInspectorBase
    {
        private QuantumConsole DevConsoleInstance;
        ...
        protected override void OnEnable()
        {
            ...
            DevConsoleInstance = (QuantumConsole)target;
            DevConsoleInstance.OnStateChange += Repaint;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_themeProperty.objectReferenceValue)
            {
                ...
                {
                    Undo.RecordObject(DevConsoleInstance, "Applied a theme to the Quantum Console");
                    DevConsoleInstance.ApplyTheme((QuantumTheme)_themeProperty.objectReferenceValue, true);
                    PrefabUtil.RecordPrefabInstancePropertyModificationsFullyRecursive(DevConsoleInstance.gameObject);
                    EditorUtility.SetDirty(DevConsoleInstance);
                }
            }
