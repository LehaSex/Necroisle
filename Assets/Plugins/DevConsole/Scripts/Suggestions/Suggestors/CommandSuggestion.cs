...
{
    public class CommandSuggestion : IDevConsoleSuggestion
    {
        ...
        private readonly Dictionary<ParameterInfo, IDevConsoleSuggestorTag[]> _parameterTagsCache = new Dictionary<ParameterInfo, IDevConsoleSuggestorTag[]>();
        ...
        private IDevConsoleSuggestorTag[] GetParameterTags(int paramIndex)
        {
            ParameterInfo parameter = _command.MethodParamData[paramIndex];
            if (_parameterTagsCache.TryGetValue(parameter, out IDevConsoleSuggestorTag[] tags))
            {
                return tags;
            }
