...
namespace Necroisle.DevConsole.Suggestors
{
    ...
    public class CommandSuggestor : BasicCachedDevConsoleSuggestor<CollapsedCommand>
    {
        ...
        protected override IDevConsoleSuggestion ItemToSuggestion(CollapsedCommand collapsedCommand)
        {
        ...
        protected override bool IsMatch(SuggestionContext context, IDevConsoleSuggestion suggestion, SuggestorOptions options)
        {
