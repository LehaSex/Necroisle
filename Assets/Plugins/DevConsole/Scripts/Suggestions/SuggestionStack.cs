...
namespace Necroisle.DevConsole
{
    ...
    public class SuggestionStack
    {
        ...
        /// </summary>
        public IDevConsoleSuggestion TopmostSuggestion => TopmostSuggestionSet?.CurrentSelection;
        ...
        {
            IDevConsoleSuggestion currentSuggestion = set.CurrentSelection;
        ...
        private void PopInvalidLayers()
        {
            for (int i = 0; i < _suggestionSets.Count; i++)
            {
                ...
                IDevConsoleSuggestion suggestion = set.CurrentSelection;
        ...
        private void TryAutoSelectSuggestion(SuggestionSet set, string prompt)
        {
            ...
            IDevConsoleSuggestion candidate = set.Suggestions.FirstOrDefault();
        ...
        public string GetCompletion()
        {
            ...
            IEnumerable<IDevConsoleSuggestion> suggestionChain =
                _suggestionSets
            ...
            foreach (IDevConsoleSuggestion suggestion in suggestionChain)
            {
