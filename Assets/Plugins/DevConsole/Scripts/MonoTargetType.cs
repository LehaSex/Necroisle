namespace Necroisle.DevConsole
{
    ...
    public enum MonoTargetType
    {
        ...
        /// <summary>
        /// Targets all instances registered in the QuantumConsoleProcessor registry. Instances can be added using <c>Necroisle.DevConsole.QuantumConsoleProcessor.RegisterObject</c>.
