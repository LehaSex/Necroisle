...
namespace Necroisle
{
    ...
    public class MapManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            PlayerController playerController = PlayerController.GetFirst();
            ...
            if (controls && controls.IsPressMap() && playerController.IsControlsEnabled())
            {
                MapUI.Get().Toggle();
            }
        ...
        {
            PlayerData mdata = PlayerData.Get();
            if (mdata != null)
