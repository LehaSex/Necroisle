...
namespace Necroisle
{
    ...
    public class PlayerControlsMouse : MonoBehaviour
    {
        ...
        public void RaycastFloorPos()
        {
            ...
            //Debug.DrawLine(CameraController.GetCamera().transform.position, floor_pos);
        }
        ...
        {
            return CameraController.GetCamera().ScreenPointToRay(GetCursorPosition());
        }
        ...
        public Vector3 GetMouseWorldPosition()
        {
            ...
            return CameraController.GetCamera().ScreenToWorldPoint(mouse);
        }
        ...
        {
            return CameraController.Get().IsInside(GetMousePosition());
        }
