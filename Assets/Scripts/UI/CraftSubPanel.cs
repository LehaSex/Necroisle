...
namespace Necroisle
{
    ...
    public class CraftSubPanel : UISlotPanel
    {
        ...
        {
            PlayerController player = PlayerController.Get(GetPlayerID());
        ...
        {
            return parent_ui ? parent_ui.GetPlayer() : PlayerController.GetFirst();
        }
        ...
        public static CraftSubPanel Get(int player_id=0)
        {
            ...
            {
                PlayerController player = panel.GetPlayer();
