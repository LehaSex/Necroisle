...
namespace Necroisle
{
    ...
    public class ActionSelector : UISlotPanel
    {
        ...
        protected override void Update()
        {
            ...
            Vector3 dir = CameraController.Get().GetFacingFront();
        ...
        public void Show(PlayerController character, Selectable select, Vector3 pos)
        {
        ...
        public static ActionSelector Get(int player_id=0)
        {
            foreach (ActionSelector panel in selector_list)
            {
                ...
                {
                    panel.character = PlayerController.Get(player_id); //Assign character
                }
