...
namespace Necroisle {
    ...
    public class PlayerUI : UIPanel
    {
        ...
        public TextMeshProUGUI build_mode_text;
        ...
        protected override void Start()
        {
            ...
            PlayerController ui_player = GetPlayer();
            if (ui_player != null)
        ...
        protected override void Update()
        {
            ...
            PlayerController character = GetPlayer();
            ...
            if (tps_cursor != null)
                tps_cursor.enabled = CameraController.Get().IsFreeRotation();
            ...
            if (controls.IsPressCraft() && character.IsControlsEnabled())
            {
        ...
        {
            return PlayerController.Get(player_id);
        }
