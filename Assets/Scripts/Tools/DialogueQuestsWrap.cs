...
namespace Necroisle
{
    ...
    public class DialogueQuestsWrap : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.LogError("Dialogue Quests: Integration failed - Make sure to add the DQManager and Necroisle Manager to the scene");
            }
        ...
        private void Start()
        {
            ...
            if (player == null)
            {
                Debug.LogError("Dialogue Quests: Integration failed - Make sure to add the Actor script on the PlayerController, with an ActorData that has is_player to true ");
            }
        }
        ...
        private void InitActor(Actor actor)
        {
            if (actor != null)
            {
                ...
                if (select != null)
                {
                    ...
                    select.onUse += (PlayerController character) =>
                    {
                        character.StopMove();
