...
namespace Necroisle
{
    ...
    public abstract class MAction : SAction
    {
        ...
        public virtual void DoAction(PlayerController character, ItemSlot slot, ItemSlot slot_other)
        {

        }

        //When using an ItemData action on a Selectable (ex: cook meat)
        public virtual void DoAction(PlayerController character, ItemSlot slot, Selectable select)
        {

        }

        //Condition when merging item-item, override if you need to add a new condition
        public virtual bool CanDoAction(PlayerController character, ItemSlot slot, ItemSlot slot_target) //slot_target is the one without the action
        {
        ...
        public virtual bool CanDoAction(PlayerController character, ItemSlot slot, Selectable select)
        {
