...
namespace Necroisle
{
    ...
    [CreateAssetMenu(fileName = "Action", menuName = "Necroisle/Actions/Repair", order = 50)]
    public class ActionRepair : MAction
    {
        public float duration = 0.5f;

        //Repair Items
        public override void DoAction(PlayerController character, ItemSlot slot, ItemSlot slot_other)
        {
        ...
        public override bool CanDoAction(PlayerController character, ItemSlot slot, ItemSlot slot_other)
        {
