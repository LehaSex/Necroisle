...
namespace Necroisle
{
    ...
    [CreateAssetMenu(fileName = "CharacterData", menuName = "Necroisle/CharacterData", order = 2)]
    public class CharacterData
    {
        ...
        public int max_thirst = 100;
        public float max_speed = 4f;

        [Header("Prefab")]
        public GameObject character_prefab;

        private static List<CharacterData> char_data = new List<CharacterData>(); //For looping
        private static Dictionary<string, CharacterData> char_dict = new Dictionary<string, CharacterData>(); //Faster access

        public static CharacterData Get(string char_id)
        {
            if (char_id != null && char_dict.ContainsKey(char_id))
...
4,
    ...
    [CreateAssetMenu(fileName = "ItemData", menuName = "Necroisle/ItemData", order = 2)]
