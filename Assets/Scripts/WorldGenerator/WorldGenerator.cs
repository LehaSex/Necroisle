...
namespace Necroisle.WorldGen
{
    ...
    public class WorldGenerator : MonoBehaviour
    {
        ...
        private void FixStartingZone()
        {
            ...
            //Find closest zone
            PlayerController player = PlayerController.GetFirst();
        ...
        public void NoisyEdges()
        {
            ...
            foreach (BiomeZone zone in zones)
            {
                zone.GenerateNoise(levels, amplitude);
            }
        }

        public void FixOverlappingPoints()
        {
            if (!AreZonesGenerated())
                return;
        ...
        public void GenerateWalls()
        {
            ...
            GameObject w1 = GenerateWall(new Vector3(map_size, 0f, 0f), 70f, 0.001f, map_size * 2f + 120f);
            GameObject w2 = GenerateWall(new Vector3(-map_size, 0f, 0f), 70f, 0.001f, map_size * 2f + 120f);
            GameObject w3 = GenerateWall(new Vector3(0f, 0f, map_size), map_size * 2f, 0.001f, 70f);
            GameObject w4 = GenerateWall(new Vector3(0f, 0f, -map_size), map_size * 2f, 0.001f, 70f);
        ...
        {
            GameObject wall = GameObject.Instantiate(walls_prefab);
            wall.name = "wall";
            wall.isStatic = true;
