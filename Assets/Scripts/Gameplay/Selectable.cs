...
namespace Necroisle
{
    ...
    public class Selectable : MonoBehaviour
    {
        ...
        public UnityAction<PlayerController> onUse; //After clicked, when character reaches use distance, or when using action button while nearby
        ...
        public void Use(PlayerController character, Vector3 pos)
        {
            if (enabled)
            {
        ...
        public AAction FindAutoAction(PlayerController character)
        {
        ...
        public bool IsInUseRange(PlayerController character)
        {
        ...
        public float GetUseRange(PlayerController character)
        {
        ...
        {
            float dist = (transf.position - CameraController.Get().GetTargetPos()).magnitude;
        ...
        public static Selectable GetNearestRaycast(float range=10f)
        {
            ...
            Vector3 pos = CameraController.Get().transform.position;
