...
namespace Necroisle
{
    ...
    public class Destructible : MonoBehaviour
    {
        ...
        public UnityAction<PlayerController> onDamagedByPlayer;
        ...
        public void TakeDamage(PlayerController attacker, int damage)
        {
            if (!dead)
            {
                ApplyDamage(damage);
        ...
        public static Destructible GetNearestAutoAttack(PlayerController character, Vector3 pos, float range = 999f)
        {
