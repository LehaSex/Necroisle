...
namespace Necroisle
{
    ...
    public class AnimalWild : MonoBehaviour
    {
        ...
        private PlayerController player_target = null;
        ...
        void FixedUpdate()
        {
            ...
            float dist = (CameraController.Get().GetTargetPos() - transform.position).magnitude;
        ...
        private void DetectThreat(float range)
        {
            ...
            foreach (PlayerController player in PlayerController.GetAll())
            {
        ...
        public void AttackTarget(PlayerController target)
        {
            if (target != null)
            {
                ChangeState(AnimalState.Attack);
        ...
        public void EscapeTarget(PlayerController target)
        {
            if (target != null)
            {
                ChangeState(AnimalState.Escape);
        ...
        private void OnDamagedPlayer(PlayerController player)
        {
