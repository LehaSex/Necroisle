...
namespace Necroisle
{
    ...
    public class Buildable : MonoBehaviour
    {
        ...
        private PlayerController building_character = null;
            ...
            if (building_mode && building_character != null)
            {
                ...
                if (!position_set)
                {
                    if (constrols.IsGamePad())
                    {
                        ...
                        Vector3 forward = CameraController.Get().IsFreeRotation() ? CameraController.Get().GetFacingFront() : building_character.transform.forward;
                    ...
                    else
                    {
                        ...
                        transform.rotation = Quaternion.Euler(0f, manual_rotate, 0f) * CameraController.Get().GetFacingRotation();
                    }
        ...
        public void StartBuild(PlayerController character)
        {
            building_mode = true;
            position_set = false;
        ...
        public bool CheckIfOverlap()
        {
            ...
            foreach (Collider overlap in overlap_colliders)
            {
                if (overlap != null)
                {
                    ...
                    PlayerController player = overlap.GetComponent<PlayerController>();
        ...
        public float GetBuildRange(PlayerController character)
        {
