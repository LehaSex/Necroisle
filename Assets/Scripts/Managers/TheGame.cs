...
namespace Necroisle
{
    ...
    public class TheGame : MonoBehaviour
    {
            ...
            if (!string.IsNullOrEmpty(pdata.current_scene) && pdata.current_scene == scene)
            {
                foreach (PlayerController player in PlayerController.GetAll())
                {
                    ...
                    if (pdata.current_entry_index < 0)
                    {
                        ...
                        CameraController.Get().MoveToTarget(player.Data.position);
                    }
                    ...
                    if (pdata.current_entry_index > 0)
                    {
                        ...
                        if (zone != null)
                        {
                            ...
                            CameraController.Get().MoveToTarget(pos);
                        }
                    }
        ...
        void Update()
        {
            ...
            //Check if dead
            PlayerController character = PlayerController.GetFirst();
        ...
        [Command("time", "Set the time of day (0-24)")]
        ...
        [Command("newgame", "Starts New Game")]
